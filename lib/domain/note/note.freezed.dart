...
mixin _$Note {
  ...
  TodoList<TodoItem> get todos => throw _privateConstructorUsedError;
...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call(
      {UniqueId id, NoteBody body, NoteColor color, TodoList<TodoItem> todos});
}
...
abstract class _Note extends Note {
  const factory _Note(
      ...
      required NoteBody body,
      required NoteColor color,
      required TodoList<TodoItem> todos}) = _$_Note;
